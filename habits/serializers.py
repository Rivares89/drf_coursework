...
from habits.validators import (RelateAndRewardValidator,
                               HabitRelatedHabitIsPleasantValidator,
                               HabitPleasantValidator,
                               HabitTimeDurationValidator, CheckHabitValidator)
...
class HabitSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        validators = [
            ...
            HabitRelatedHabitIsPleasantValidator(field1='related_habit',
                                                 field2='is_pleasant'),
            HabitPleasantValidator(field1='related_habit',
                                   field2='reward', field3='is_pleasant'),
